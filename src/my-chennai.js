...
class MyChennai extends PolymerElement {
    static get template() {
        return html `
  ...
  <nav>
    ...
    <ul>
      ...
      <div class="row">
          ...
          <iron-image sizing="contain" class="img" alt="The Polymer logo." src="../images/chennai (1).jpg"></iron-image>
            ...
            <!---About Chennai--->
              <div class="">
                  ...
                  <h1 style="text-align:center;">About Chennai</h1>
...
window.customElements.define('my-chennai', MyChennai);